...
Luck of the Draw Golf Club uses Digital Ocean S3 (Simple Storage Service) storage for static and
media files.
...
Luck of the Draw Golf Club provides the means in `config/settings/local.py` to select which
