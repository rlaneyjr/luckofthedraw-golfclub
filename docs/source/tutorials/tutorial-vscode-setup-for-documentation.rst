...
Luck of the Draw Golf Club use restructured text (reST) and the `Sphinx` [#]_ documentation
build engine.
...
of `luckofthedraw-golfclub.code-workspace` and without any extensions.
...
.. code-block:: json

    {
        ...
        "settings": {
            ...
            "liveServer.settings.multiRootWorkspaceName": "luckofthedraw-golfclub",
            "[python]": {
